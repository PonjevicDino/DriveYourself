...
public class RCC_Editor : Editor {
    ...
    public void WheelSettingsTab() {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.PropertyField(serializedObject.FindProperty("SteeringWheel"), new GUIContent("Steering Wheel Model", "In case of if your vehicle has individual steering wheel model in the interior."), false);
    ...
    public void ConfigurationTab() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("automaticGear"), new GUIContent("Automatic Gearbox", "Automatic gear shifting."), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("automaticClutch"), new GUIContent("Automatic Clutch", "Automatic clutch input."), false);
        EditorGUILayout.Space();
    ...
    public void CustomizerTab() {
        ...
        if (!customizerFound) {
            ...
            if (GUILayout.Button("Remove Customizer Component")) {
                ...
                DestroyImmediate(carScript.gameObject.GetComponent<RCC_Customizer>());
                EditorUtility.SetDirty(carScript);
